...
#define TEMBOO_ACCOUNT "mankurt"  // Your Temboo account name 
#define TEMBOO_APP_KEY_NAME "myFirstApp"  // Your Temboo app name
#define TEMBOO_APP_KEY "g9bmTtpyp4GEAgVuIXlq3SiTHs7fYe8V"  // Your Temboo app key

#define WIFI_SSID "OpenAir"
#define WPA_PASSWORD "CloseAir"
